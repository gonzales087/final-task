...
if(isset($_POST['submit'])){
    ...
    $sql="insert into `crud_final` (course, subject_code, course_id, course_description, total_units)
    values('$course', '$subject_code', '$course_id', '$course_description', '$total_units')";
...
<body>
    ...
    <footer>
        <h1>
            Mark Ronnie Emata      &nbsp;&nbsp;&nbsp;&nbsp;  Jose Marie Gonzales
        </h1>
    </footer>
